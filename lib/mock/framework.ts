 ...
 * `sections` + `items` tables (9 sections, 81 items as of the second
 ...
 * connection.
 *
 * Second resync note: NECA revised the framework and edited the live
 * `items` table directly (21 items deleted, 14 revised — some
 * substantially, e.g. G4/G5/G9 became regulatory-compliance questions
 * under the same item codes, replacing their prior ESG/environmental/
 * impact-measurement content). This file was rebuilt to match exactly;
 * every prompt/evidence/track value below was re-pulled from the live
 * `items` table, not preserved from the prior version. D7 and I5 (and
 * their custom scoring rules in lib/scoring/stage1.ts) were deleted
 * outright, not revised.
 *
 ...
 * Only 3 percentage items survived this resync (B7, H1, H2) — C17, C19,
 * C22, and E8 were all deleted, so their BenchmarkBand keys are gone too.
 *
...
export const ASSESSMENT_ITEMS: AssessmentItem[] = [
  ...
  yn({ id: "B12", dbId: "a45b68ea-ac8f-4607-b503-63a141b99538", pillarCode: "B", order: 12, prompt: "Our organisation has a documented Business Continuity / Disaster Recovery Plan.", track: "advanced", evidenceName: "Business Continuity / Disaster Recovery Plan/Document" }),
  ...
  yn({ id: "C10", dbId: "33df2164-93b7-4f86-bd3a-965b1eaca357", pillarCode: "C", order: 10, prompt: "Training needs are formally identified before L&D programmes are designed.", track: "mandatory", evidenceName: "Latest Training needs analysis" }),
  yn({ id: "C11", dbId: "32adc0fb-7851-4640-929c-9d51d2d271a8", pillarCode: "C", order: 11, prompt: "Our organisation conducts post-training evaluations to measure outcomes and impact on performance.", track: "advanced", evidenceName: "Latest Evaluation report" }),
  ...
  yn({ id: "G7", dbId: "5c878b70-0dff-4723-b7b0-3c20dafa6641", pillarCode: "G", order: 7, prompt: "Our organisation has a documented human rights policy.", track: "mandatory", evidenceName: "Human Rights Policy/ Code of Conduct/Code of Ethics" }),
  ...
  yn({ id: "G10", dbId: "3ac7ad7f-3ce9-4435-8be3-08fc1b24400d", pillarCode: "G", order: 10, prompt: "Our organisation monitors CSR/ESG impact and shares results with stakeholders.", track: "advanced", evidenceName: "Impact/Sustainability report" }),
